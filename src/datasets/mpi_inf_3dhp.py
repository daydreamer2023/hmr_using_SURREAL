...
from src.datasets.common import convert_to_example_wmosh, ImageCoder, resize_img
from src.datasets.read_mpi_inf_3dhp import get_paths, read_mat, mpi_inf_3dhp_to_lsp_idx, read_camera

tf.app.flags.DEFINE_string('data_directory', '/home/cha/SamSung/DataSet/data/mpi_inf_3dhp',
                           'data directory: top of mpi-inf-3dhp')
tf.app.flags.DEFINE_string('output_directory',
                           '/home/cha/SamSung/DataSet/tf_datasets/mpi_inf_3dhp',
...
def get_all_data(base_dir, sub_id, seq_id, cam_ids, all_cam_info):
    ...
    for cam_id in cam_ids:
        base_path = join(img_dir, 'video_%d' % cam_id, 'frame_%d.jpg')
